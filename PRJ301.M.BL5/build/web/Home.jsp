        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    String txtSearch = ""; 
                    %>
                    <form action="FilterController"  class="d-flex w-50">
                        <input type="hidden" name="service" value="search" />                       
                        <input name="txtSearch" class="form-control me-2" type="search" placeholder="" value="<%= txtSearch %>">
                               aria-label="Search">
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="Cart.jsp">Show Cart</a></li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="FilterController">      
                            ...
                            <select onchange="this.form.submit()" name="sid" >
                                <option value="-1">All Stores</option>
                                <% Vector<Store> vectorA =(Vector<Store>)request.getAttribute("store");%>
                                <%for (Store st : vectorA) {%>
                                    <option <%=st.getStore_id()%> ? "selected":"" value="<%=st.getStore_id()%>"><%=st.getStore_name()%></option>
                                <%}%>
                            </select>                           
                        </form>                           
                        <br>                           
