    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if(dao.login(username, password) == true){
                     Vector<Customer> vector = dao.getCustomers("select * from customers where email='"+username+"' ");
                     for(Customer st : vector){
                    ...
                    RequestDispatcher dis = request.getRequestDispatcher("LoginCus.jsp");                
                    dis.forward(request, response);
