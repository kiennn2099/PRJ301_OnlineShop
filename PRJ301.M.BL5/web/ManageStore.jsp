<%-- 
    ...
    Created on : Aug 23, 2023, 10:18:51 PM
    Author     : admin
--%>
        ...
        <div id="layoutSidenav">
            ...
            <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">  
                                <a  style="float: right; margin-left: 100px" class="btn btn-info" href="MVCStoreController?service=insertStore">Add New</a>                               
                                ...
                                <%for (Store sto : vector) {%>
                                        <tr>
                                            ...
                                            <td><a href="MVCStoreController?service=updateStore&sid=<%=sto.getStore_id()%>">update</a></td>
                                            <td><a href="MVCStoreController?service=deleteStore&sid=<%=sto.getStore_id()%>">delete</a></td>                                            
                                        </tr>
                                <%}%>
                                    </tbody>
                                </table>
